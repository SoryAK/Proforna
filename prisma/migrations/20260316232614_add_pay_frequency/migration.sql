...
INSERT INTO "new_CurrentPosition" ("address", "company", "companySynopsis", "createdAt", "currency", "department", "description", "differentials", "endDate", "focus", "id", "industry", "isActive", "location", "managerName", "payRate", "payType", "responsibilities", "role", "salary", "schedule", "startDate", "techStack", "type", "updatedAt", "website") SELECT "address", "company", "companySynopsis", "createdAt", "currency", "department", "description", "differentials", "endDate", "focus", "id", "industry", "isActive", "location", "managerName", "payRate", "payType", "responsibilities", "role", "salary", "schedule", "startDate", "techStack", "type", "updatedAt", "website" FROM "CurrentPosition";
